...
<head>
    <title>Shopify → Magento Column Mapping</title>
...
<div class="wrapper">
    <div class="card">
        ...
        <small>Shopify → Magento</small>

        <div class="subtitle">
            Map Shopify CSV columns to Magento product fields.
        </div>

        <form method="post" action="shopify_to_magento_step3_process.php">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="map[<?= htmlspecialchars($col) ?>]">
                                ...
                                <option value="product.url_key">URL Key</option>
